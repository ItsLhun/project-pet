...
function calendarJs(id, options, startDateTime) {
  ...
  function build(newStartDateTime, fullRebuild) {
    ...
    _element_HeaderDateDisplay_Text.innerText =
      _options.monthNames[_currentDate.getMonth()] +
      ', ' +
      _currentDate.getFullYear() +
      ' ▾';
  }
  ...
  function buildDateHeader() {
    ...
    if (_options.showExtraMainDisplayToolbarButtons) {
      ...
      buildToolbarButton(
        _element_HeaderDateDisplay,
        'ib-hamburger',
        _options.listWeekEventsTooltipText,
        function () {
      ...
      if (_options.fullScreenModeEnabled) {
        _element_HeaderDateDisplay_FullScreenButton = buildToolbarButton(
          _element_HeaderDateDisplay,
  ...
  function buildDayNamesHeader() {
    if (_options.showDayNamesInMainDisplay) {
      ...
      for (
        ...
        headerNameIndex < headerNamesLength;
        headerNameIndex++
      ) {
  ...
  function buildYearSelectorDropDown(container) {
    var date = new Date(1900, 1, 1),
      ...
      dateYearsTotal =
        ...
        date.getFullYear() +
        _options.extraSelectableYearsAhead;

    _element_HeaderDateDisplay_YearSelector = createElement(
      'div',
      'years-drop-down'
    );
    container.appendChild(_element_HeaderDateDisplay_YearSelector);

    _element_HeaderDateDisplay_YearSelector_Contents = createElement(
      'div',
      'contents custom-scroll-bars'
    );
    _element_HeaderDateDisplay_YearSelector.appendChild(
  ...
  function showYearSelectorDropDownMenu(e) {
    ...
    if (_element_HeaderDateDisplay_YearSelector.style.display !== 'block') {
      ...
      if (year !== null) {
        _element_HeaderDateDisplay_YearSelector_Contents.scrollTop =
          year.offsetTop -
          _element_HeaderDateDisplay_YearSelector.offsetHeight / 2;
      } else {
  ...
  function updateYearSelectorDropDownMenuColors() {
    var yearSelected =
        _element_HeaderDateDisplay_YearSelector.getElementsByClassName('year'),
    ...
    var year = getElementByID(
      _elementID_YearSelected + _currentDate.getFullYear()
    );
    if (year !== null) {
  ...
  function buildDayEventPlusText(elementDay, dayDate) {
    ...
    if (plusXEventsText === null) {
      ...
      plusXEventsText.innerText =
        '+' + numberOfEvents + ' ' + _options.moreText;
    }
  }
  ...
  function getDayElement(date) {
    ...
    if (
      ...
      elementDayNumber =
        firstDayNumber - getTotalDaysBetweenDates(date, _currentDate) + 1;
    } else if (
      ...
      for (var columnDataIndex = 0; columnDataIndex < 7; columnDataIndex++) {
        var columnDataNumber = rowIndex * 7 + (columnDataIndex + 1),
          columnDataElement = getElementByID(
            _elementID_DayElement + columnDataNumber
          );
  ...
  function buildFullDayView() {
    ...
    _element_FullDayView_TodayButton = buildToolbarButton(
      titleBar,
      'ib-pin',
      _options.todayTooltipText,
      onToday
    ...
    _element_FullDayView_Contents = createElement(
      'div',
      'contents custom-scroll-bars'
    );
    ...
    _element_FullDayView_Contents_AllDayEvents = createElement(
      'div',
      'content-events-all-day'
    );
    _element_FullDayView_Contents.appendChild(
      _element_FullDayView_Contents_AllDayEvents
    );
    ...
    _element_FullDayView_Contents_Hours = createElement(
      'div',
      'contents-events'
    );
    _element_FullDayView_Contents_Hours.ondblclick = fullDayViewDoubleClick;
    _element_FullDayView_Contents.appendChild(
      _element_FullDayView_Contents_Hours
    );
    ...
    if (_options.manualEditingEnabled) {
      var contentHoursOffset = getOffset(_element_FullDayView_Contents_Hours),
        ...
        minutesFromTop = Math.floor(
          (e.pageY - (contentHoursOffset.top + scrollPosition.top)) /
            pixelsPerMinute
        ),
      ...
      showEventEditingDialog(
        null,
        _element_FullDayView_DateSelected,
        hoursMinutes
      );
    }
  }
  ...
  function showFullDayView(date, fromOpen) {
    ...
    for (
      ...
      var newTopPosition = buildFullDayDayEvent(
    ...
    if (fromOpen) {
      if (isFullDayTimeArrowVisible()) {
        ...
        _element_FullDayView_Contents.scrollTop =
          orderedEventsFirstTopPosition -
          _element_FullDayView_Contents.offsetHeight / 2;
      }
    }
  ...
  function buildFullDayRepeatedDayEvents(
    event,
    orderedEvents,
    date,
    dateFunc,
    ...
    while (newFromDate < date) {
      ...
      var repeatEnded = !(
        !isDefined(event.repeatEnds) ||
        isDateSmallerOrEqualToDate(newFromDate, event.repeatEnds)
      );
      ...
      if (
        ...
        if (eventDetails.from.getDate() === eventDetails.to.getDate()) {
          if (eventDetails.isAllDay) {
            ...
            startTime.innerText = getTimeToTimeDisplay(
              eventDetails.from,
              eventDetails.to
            );
  ...
  function setEventPositionAndGetScrollTop(displayDate, event, eventDetails) {
    ...
    if (
      ...
      contentHoursHeight - _options.spacing
    ) {
      event.style.height =
        contentHoursHeight - event.offsetTop - _options.spacing * 3 + 'px';
    }
  ...
  function adjustFullDayEventsThatOverlap() {
    var eventsElements =
        _element_FullDayView_Contents_Hours.getElementsByClassName('event'),
  ...
  function buildFullDayViewTimeArrow() {
    ...
    _element_FullDayView_Contents_Hours.appendChild(
      _element_FullDayView_TimeArrow
    );

    _element_FullDayView_TimeArrow.appendChild(
  ...
  function updateFullDayViewTimeArrowPosition() {
    ...
    if (isFullDayTimeArrowVisible()) {
      ...
      _element_FullDayView_TimeArrow.style.top =
        top - _element_FullDayView_TimeArrow.offsetHeight / 2 + 'px';
      topPosition = top;
    } else {
  ...
  function isFullDayTimeArrowVisible() {
    return (
      isDateToday(_element_FullDayView_DateSelected) &&
      isOverlayVisible(_element_FullDayView) &&
      _options.showTimelineArrowOnFullDayView
    );
  }
  ...
  function buildListAllWeekEventsView() {
    _element_ListAllWeekEventsView = createElement(
      'div',
      'list-all-week-events-view'
    );
    ...
    _element_ListAllWeekEventsView_Contents = createElement(
      'div',
      'contents custom-scroll-bars'
    );
  ...
  function showListAllWeekEventsView(weekDate, fromOpen) {
    ...
    for (
      ...
      for (var dayIndex = 0; dayIndex < totalDays; dayIndex++) {
        if (nextDate >= weekStartDate && nextDate <= weekEndDate) {
          ...
          if (dayContents !== null && dayHeader !== null) {
            var added = buildListAllWeekEventsEvent(
              orderedEvent,
              dayHeader,
              dayContents,
              nextDate
      ...
      if (repeatEvery > _repeatType.never) {
        if (repeatEvery === _repeatType.everyDay) {
          repeatAdded = buildAllWeekRepeatedDayEvents(
            orderedEvent,
            weekStartDate,
            weekEndDate,
            moveDateForwardDay,
  ...
  function buildAllWeekRepeatedDayEvents(
    orderedEvent,
    weekStartDate,
    weekEndDate,
    dateFunc,
  ...
  function buildListAllEventsDay(date) {
    ...
    if (
      ...
      _options.visibleDays.indexOf(weekDayNumber) > -1
    ) {
      ...
      if (
        _element_ListAllWeekEventsView_Contents_FullView_Contents.hasOwnProperty(
          dateID
        )
      ) {
  ...
  function buildDay(
    ...
    if (dayElement !== null) {
      ...
      dayText.className +=
        dayIsToday && !_datePickerModeEnabled ? ' today' : '';
  ...
  function getHoliday(date) {
    ...
    for (var holidayIndex = 0; holidayIndex < holidaysLength; holidayIndex++) {
      ...
      if (
        getNumber(holiday.day) === date.getDate() &&
        getNumber(holiday.month) === date.getMonth() + 1 &&
        holidayText !== '' &&
  ...
  function dropEventOnDay(e, year, month, day) {
    ...
    if (
      _eventDetails_Dragged !== null &&
      !doDatesMatch(_eventDetails_Dragged_DateFrom, dropDate)
    ) {
      if (!isDefined(day)) {
      ...
      var daysBetweenDraggedFromAndFrom = getTotalDaysBetweenDates(
          _eventDetails_Dragged.from,
          _eventDetails_Dragged_DateFrom
        ),
        daysBetweenFromAndTo = getTotalDaysBetweenDates(
          _eventDetails_Dragged.from,
          _eventDetails_Dragged.to
        ),
        fromDate = new Date(
          year,
          month,
          day,
          _eventDetails_Dragged.from.getHours(),
          _eventDetails_Dragged.from.getMinutes()
        ),
        toDate = new Date(
          year,
          month,
          day,
          _eventDetails_Dragged.to.getHours(),
          _eventDetails_Dragged.to.getMinutes()
        ),
  ...
  function buildDayDropDownMenu() {
    ...
    if (_options.manualEditingEnabled) {
      _element_DropDownMenu_Day_Paste_Separator = buildMenuSeparator(
        _element_DropDownMenu_Day
      );

      _element_DropDownMenu_Day_Paste = buildMenuItemWithIcon(
        _element_DropDownMenu_Day,
        'ib-circle-icon',
        _options.pasteText,
        function () {
  ...
  function buildEventDropDownMenu() {
    ...
    _element_DropDownMenu_Event = createElement(
      'div',
    ...
    if (_options.manualEditingEnabled) {
      ...
      buildMenuItemWithIcon(
        ...
        _options.copyText,
        function () {
          _copiedEventDetails = cloneEventDetails(
            _element_DropDownMenu_Event_EventDetails
          );
        }
      );
        ...
        function () {
          ...
          var onYesEvent = function () {
            ...
            if (isDefined(_element_DropDownMenu_Event_EventDetails.id)) {
              if (
                !_element_ConfirmationDialog_RemoveAllEvents.checked &&
                _element_DropDownMenu_Event_FormattedDateSelected !== null
              ) {
                if (
                  isDefinedArray(
                    _element_DropDownMenu_Event_EventDetails.seriesIgnoreDates
                  )
                ) {
                  _element_DropDownMenu_Event_EventDetails.seriesIgnoreDates.push(
                    _element_DropDownMenu_Event_FormattedDateSelected
                  );
                } else {
                  _element_DropDownMenu_Event_EventDetails.seriesIgnoreDates = [
                    _element_DropDownMenu_Event_FormattedDateSelected
          ...
          var repeatEvery = getNumber(
              _element_DropDownMenu_Event_EventDetails.repeatEvery
            ),
            showCheckBox =
              repeatEvery > _repeatType.never &&
              _element_DropDownMenu_Event_FormattedDateSelected !== null;
      ...
      _element_DropDownMenu_Event_OpenUrlSeparator = buildMenuSeparator(
        _element_DropDownMenu_Event
      );
    }

    _element_DropDownMenu_Event_OpenUrl = buildMenuItemWithIcon(
      _element_DropDownMenu_Event,
      'ib-arrow-top-right-icon',
      _options.openUrlText,
      function () {
        _window.open(
          _element_DropDownMenu_Event_EventDetails.url,
  ...
  function buildFullDayViewDropDownMenu() {
    ...
    if (_options.manualEditingEnabled) {
      _element_DropDownMenu_FullDay = createElement(
        'div',
        'calendar-drop-down-menu'
      );
      ...
      if (_options.manualEditingEnabled) {
        _element_DropDownMenu_FullDay_Paste_Separator = buildMenuSeparator(
          _element_DropDownMenu_FullDay
        );

        _element_DropDownMenu_FullDay_Paste = buildMenuItemWithIcon(
          _element_DropDownMenu_FullDay,
          'ib-circle-icon',
          _options.pasteText,
          function () {
  ...
  function buildDayHeaderDropDownMenu() {
    ...
    _element_DropDownMenu_HeaderDay = createElement(
      'div',
      'calendar-drop-down-menu'
    );
  ...
  function buildMenuItemWithIcon(
    container,
    iconCSS,
    text,
    onClickEvent,
  ...
  function showEventDropDownMenu(e, eventDetails, selectedDate) {
    ...
    _element_DropDownMenu_Event_FormattedDateSelected = isDefined(selectedDate)
      ? selectedDate
      : null;
    ...
    if (
      display === 'block' ||
      _element_DropDownMenu_Event.childElementCount > 2
    ) {
      hideAllDropDowns();
      cancelBubble(e);
  ...
  function buildEventEditingDialog() {
    ...
    _element_EventEditorDialog = createElement(
      'div',
    ...
    _element_EventEditorDialog_DisabledArea = createElement(
      'div',
      'disabled-area'
    );
    ...
    _element_EventEditorDialog_OKButton = createButtonElement(
    ...
    _element_EventEditorDialog_RemoveButton = createButtonElement(
      contents,
      _options.removeEventText,
      'remove',
  ...
  function buildEventEditorEventTabContent() {
    ...
    if (_options.maximumEventTitleLength > 0) {
      _element_EventEditorDialog_Title.maxLength =
    ...
    createTextHeaderElement(
      _element_EventEditorDialog_Tab_Event,
      _options.fromText.replace(':', '') + '/' + _options.toText
    );
    ...
    _element_EventEditorDialog_IsAllDay = buildCheckBox(
      _element_EventEditorDialog_Tab_Event,
      _options.isAllDayText,
      isAllDayChanged
    )[0];
    _element_EventEditorDialog_ShowAlerts = buildCheckBox(
      _element_EventEditorDialog_Tab_Event,
      _options.showAlertsText
    )[0];

    //Nahuel: moved Description area to event tab
  ...
  function repeatEveryEvent() {
    _element_EventEditorDialog_RepeatEvery_RepeatOptionsButton.disabled =
      _element_EventEditorDialog_RepeatEvery_Never.checked;
    _element_EventEditorDialog_RepeatEvery_Custom_Type_Yearly.disabled =
      !_element_EventEditorDialog_RepeatEvery_Custom.checked;
    _element_EventEditorDialog_RepeatEvery_Custom_Type_Daily.disabled =
      !_element_EventEditorDialog_RepeatEvery_Custom.checked;
    _element_EventEditorDialog_RepeatEvery_Custom_Type_Weekly.disabled =
      !_element_EventEditorDialog_RepeatEvery_Custom.checked;
    _element_EventEditorDialog_RepeatEvery_Custom_Type_Monthly.disabled =
      !_element_EventEditorDialog_RepeatEvery_Custom.checked;
    _element_EventEditorDialog_RepeatEvery_Custom_Value.disabled =
      !_element_EventEditorDialog_RepeatEvery_Custom.checked;
  }
  ...
  function isAllDayChanged() {
    ...
    if (_element_EventEditorDialog_IsAllDay.checked) {
      _element_EventEditorDialog_DateTo.value =
        _element_EventEditorDialog_DateFrom.value;
  ...
  function showEventEditingDialog(
    ...
    if (isDefined(eventDetails)) {
      ...
      _element_EventEditorDialog_TimeFrom.value = toFormattedTime(
        eventDetails.from
      );
      _element_EventEditorDialog_TimeTo.value = toFormattedTime(
        eventDetails.to
      );
      _element_EventEditorDialog_IsAllDay.checked = getBoolean(
        eventDetails.isAllDay
      );
      _element_EventEditorDialog_ShowAlerts.checked = getBoolean(
      ...
      _element_EventEditorColorsDialog_ColorText.value = getString(
        eventDetails.colorText,
        _options.defaultEventTextColor
      );
      _element_EventEditorColorsDialog_ColorBorder.value = getString(
        eventDetails.colorBorder,
        _options.defaultEventBorderColor
      );
      _element_EventEditorDialog_RepeatEvery_Custom_Value.value = getNumber(
      ...
      _element_EventEditorRepeatOptionsDialog_Mon.checked =
        excludeDays.indexOf(1) > -1;
      _element_EventEditorRepeatOptionsDialog_Tue.checked =
        excludeDays.indexOf(2) > -1;
      _element_EventEditorRepeatOptionsDialog_Wed.checked =
        excludeDays.indexOf(3) > -1;
      _element_EventEditorRepeatOptionsDialog_Thu.checked =
        excludeDays.indexOf(4) > -1;
      _element_EventEditorRepeatOptionsDialog_Fri.checked =
        excludeDays.indexOf(5) > -1;
      _element_EventEditorRepeatOptionsDialog_Sat.checked =
        excludeDays.indexOf(6) > -1;
      _element_EventEditorRepeatOptionsDialog_Sun.checked =
      ...
      _element_EventEditorColorsDialog_ColorText.value =
        _options.defaultEventTextColor;
      _element_EventEditorColorsDialog_ColorBorder.value =
        _options.defaultEventBorderColor;
      _element_EventEditorDialog_RepeatEvery_Never.checked = true;
      ...
      if (!isDefinedArray(overrideTimeValues)) {
        ...
        var newTimeToDisplay =
          padNumber(overrideTimeValues[0]) +
          ':' +
          padNumber(overrideTimeValues[1]);
    ...
    buildToolbarButton(
      _element_EventEditorDialog_TitleBar,
      'ib-close',
      _options.closeTooltipText,
      eventDialogEvent_Cancel,
      true
  ...
  function setEventEditingDialogInDuplicateMode() {
    ...
    _element_EventEditorDialog_RemoveButton.style.display = 'none';
    _element_EventEditorDialog_TitleBar.innerText = _options.addEventTitle;
    _element_EventEditorDialog_EventDetails = cloneEventDetails(
      _element_EventEditorDialog_EventDetails
    );
  ...
  function eventDialogEvent_OK() {
    ...
    if (fromTime.length < 2) {
      showEventDialogErrorMessage(
        ...
        _element_EventEditorDialog_TimeFrom
      );
    } else if (toTime.length < 2) {
      showEventDialogErrorMessage(
        _options.toTimeErrorMessage,
        _element_EventEditorDialog_TimeTo
      );
    } else if (title === '') {
      showEventDialogErrorMessage(
      ...
      if (toDate < fromDate) {
        showEventDialogErrorMessage(
          ...
          _element_EventEditorDialog_DateTo
        );
      } else {
        eventDialogEvent_Cancel();
        ...
        if (_element_EventEditorDialog_RepeatEvery_Custom_Type_Daily.checked) {
          ...
          _element_EventEditorDialog_RepeatEvery_Custom_Type_Weekly.checked
        ) {
          newEvent.repeatEveryCustomType = _repeatCustomType.weekly;
        } else if (
          _element_EventEditorDialog_RepeatEvery_Custom_Type_Monthly.checked
        ) {
          newEvent.repeatEveryCustomType = _repeatCustomType.monthly;
        } else if (
          _element_EventEditorDialog_RepeatEvery_Custom_Type_Yearly.checked
        ) {
  ...
  function buildEventEditingColorDialog() {
    ...
    _element_EventEditorColorsDialog = createElement(
      'div',
  ...
  function eventColorsDialogEvent_OK() {
    ...
    _element_EventEditorDialog_EventDetails.color =
      _element_EventEditorColorsDialog_Color.value;
    _element_EventEditorDialog_EventDetails.colorText =
      _element_EventEditorColorsDialog_ColorText.value;
  ...
  function buildEventEditingRepeatOptionsDialog() {
    ...
    _element_EventEditorRepeatOptionsDialog = createElement(
      'div',
    ...
    _element_EventEditorRepeatOptionsDialog_Mon = buildCheckBox(
      contents,
      _options.dayNames[0]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Tue = buildCheckBox(
      contents,
      _options.dayNames[1]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Wed = buildCheckBox(
      contents,
      _options.dayNames[2]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Thu = buildCheckBox(
      contents,
      _options.dayNames[3]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Fri = buildCheckBox(
      contents,
      _options.dayNames[4]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Sat = buildCheckBox(
      contents,
      _options.dayNames[5]
    )[0];
    _element_EventEditorRepeatOptionsDialog_Sun = buildCheckBox(
      contents,
      _options.dayNames[6]
    )[0];
  ...
  function buildConfirmationDialog() {
    ...
    _element_ConfirmationDialog = createElement(
      'div',
    ...
    _element_ConfirmationDialog.appendChild(
      _element_ConfirmationDialog_TitleBar
    );
    ...
    _element_ConfirmationDialog_YesButton = createElement(
      'input',
      'yes',
      'button'
    );
    ...
    _element_ConfirmationDialog_NoButton = createElement(
      'input',
      'no',
      'button'
    );
  ...
  function buildSelectExportTypeDialog() {
    ...
    _element_SelectExportTypeDialog = createElement(
      'div',
      'calendar-dialog select-export-type'
    );
    ...
    _element_SelectExportTypeDialog_Option_CSV = buildRadioButton(
      radioButtonsContainer,
      'CSV',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_XML = buildRadioButton(
      radioButtonsContainer,
      'XML',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_JSON = buildRadioButton(
      radioButtonsContainer,
      'JSON',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_TEXT = buildRadioButton(
      radioButtonsContainer,
      'TEXT',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_iCAL = buildRadioButton(
      radioButtonsContainer,
      'iCAL',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_MD = buildRadioButton(
      radioButtonsContainer,
      'MD',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_HTML = buildRadioButton(
      radioButtonsContainer,
      'HTML',
      'ExportType'
    );
    _element_SelectExportTypeDialog_Option_TSV = buildRadioButton(
      radioButtonsContainer,
      'TSV',
      'ExportType'
    );
  ...
  function buildSearchDialog() {
    ...
    _element_SearchDialog_MinimizedRestoreButton = buildToolbarButton(
      titleBar,
      'ib-minus',
    ...
    _element_SearchDialog_MatchCase = buildCheckBox(
      checkboxOptionsContainer,
      _options.matchCaseText,
      searchOptionsChanged
    )[0];
    _element_SearchDialog_Advanced = buildCheckBox(
      checkboxOptionsContainer,
    ...
    _element_SearchDialog_Contents.appendChild(
      _element_SearchDialog_Advanced_Container
    );
    ...
    _element_SearchDialog_Include_Title = buildCheckBox(
      checkboxContainer,
      _options.titleText.replace(':', ''),
      searchOptionsChanged
    )[0];
    _element_SearchDialog_Include_Location = buildCheckBox(
      checkboxContainer,
      _options.locationText.replace(':', ''),
      searchOptionsChanged
    )[0];
    _element_SearchDialog_Include_Description = buildCheckBox(
      checkboxContainer,
      _options.descriptionText.replace(':', ''),
      searchOptionsChanged
    )[0];
    _element_SearchDialog_Include_Group = buildCheckBox(
      checkboxContainer,
      _options.groupText.replace(':', ''),
      searchOptionsChanged
    )[0];
    _element_SearchDialog_Include_Url = buildCheckBox(
      checkboxContainer,
      _options.urlText.replace(':', ''),
      searchOptionsChanged
    )[0];
    ...
    _element_SearchDialog_Option_StartsWith = buildRadioButton(
      radioButtonsContainer,
      _options.startsWithText,
      'SearchOptionType',
      searchOptionsChanged
    );
    _element_SearchDialog_Option_EndsWith = buildRadioButton(
      radioButtonsContainer,
      _options.endsWithText,
      'SearchOptionType',
      searchOptionsChanged
    );
    _element_SearchDialog_Option_Contains = buildRadioButton(
      radioButtonsContainer,
    ...
    _element_SearchDialog_Previous = createButtonElement(
      buttonsSplitContainer,
      _options.previousText,
      'previous',
      searchOnPrevious
    );
    _element_SearchDialog_Next = createButtonElement(
      buttonsSplitContainer,
      _options.nextText,
      'next',
      searchOnNext
  ...
  function searchOnDocumentMouseMove(e) {
    if (_element_SearchDialog_IsMoving) {
      _element_SearchDialog.style.left =
        e.pageX - _element_SearchDialog_X + 'px';
      _element_SearchDialog.style.top =
        e.pageY - _element_SearchDialog_Y + 'px';
    }
  }
  ...
  function searchForTextChanged() {
    ...
    _element_SearchDialog_Next.disabled =
  ...
  function centerSearchDialog() {
    if (!_element_SearchDialog_Moved) {
      _element_SearchDialog.style.left =
        _window.innerWidth / 2 - _element_SearchDialog.offsetWidth / 2 + 'px';
      _element_SearchDialog.style.top =
        _window.innerHeight / 2 - _element_SearchDialog.offsetHeight / 2 + 'px';
    }
  }
  ...
  function minimizeRestoreDialog() {
    if (isSearchDialogContentVisible()) {
      ...
      _element_SearchDialog_MinimizedRestoreButton.className =
        'ib-square-hollow';
      addToolTip(
        _element_SearchDialog_MinimizedRestoreButton,
  ...
  function searchOnPrevious() {
    if (_element_SearchDialog_SearchIndex > 0) {
      ...
      var eventDetails =
        _element_SearchDialog_SearchResults[_element_SearchDialog_SearchIndex];
  ...
  function searchOnEnter(e) {
    if (
      e.keyCode === 13 &&
      isControlKey(e) &&
      !_element_SearchDialog_Previous.disabled
    ) {
      searchOnPrevious();
  ...
  function searchOnNext() {
    if (_element_SearchDialog_SearchResults.length === 0) {
      var matchCase = _element_SearchDialog_MatchCase.checked,
        search = !matchCase
          ? _element_SearchDialog_For.value.toLowerCase()
          : _element_SearchDialog_For.value,
        monthYearsFound = {};
      ...
      getAllEventsFunc(function (event) {
        if (isEventVisible(event)) {
          ...
          if (
            _element_SearchDialog_Include_Title.checked &&
            isSearchTextAvailable(title, search)
          ) {
            found = true;
          } else if (
            _element_SearchDialog_Include_Location.checked &&
            isSearchTextAvailable(location, search)
          ) {
            found = true;
          } else if (
            _element_SearchDialog_Include_Description.checked &&
            isSearchTextAvailable(description, search)
          ) {
            found = true;
          } else if (
            _element_SearchDialog_Include_Group.checked &&
            isSearchTextAvailable(group, search)
          ) {
            found = true;
          } else if (
            _element_SearchDialog_Include_Url.checked &&
          ...
          if (found) {
            var monthYear =
              event.from.getMonth() + '-' + event.from.getFullYear();
  ...
  function updateSearchButtons() {
    ...
    _element_SearchDialog_Next.disabled =
      _element_SearchDialog_SearchIndex ===
        _element_SearchDialog_SearchResults.length - 1 ||
      _element_SearchDialog_SearchResults.length === 0;
  }
  ...
  function storeSearchOptions() {
    ...
    _optionsForSearch.searchLocation =
      _element_SearchDialog_Include_Location.checked;
    _optionsForSearch.searchDescription =
      _element_SearchDialog_Include_Description.checked;
    ...
    _optionsForSearch.startsWith =
      _element_SearchDialog_Option_StartsWith.checked;
  ...
  function buildConfigurationDialog() {
    ...
    _element_ConfigurationDialog = createElement(
      'div',
    ...
    buildTab(
      tabsContainer,
      _options.groupsTabText,
      function (tab) {
        showTabContents(
          tab,
          _element_ConfigurationDialog_Groups,
          _element_ConfigurationDialog
        );
      },
      true
    );
    ...
    buildTab(tabsContainer, _options.displayTabText, function (tab) {
      showTabContents(
        tab,
        _element_ConfigurationDialog_Display,
        _element_ConfigurationDialog
      );
    });
    ...
    buildTab(tabsContainer, _options.visibleDaysTabText, function (tab) {
      showTabContents(
        tab,
        _element_ConfigurationDialog_VisibleDays,
        _element_ConfigurationDialog
      );
    });

    _element_ConfigurationDialog_Groups = buildTabContents(contents, true);
    _element_ConfigurationDialog_Display = buildTabContents(
      contents,
      false,
      false
    );
    _element_ConfigurationDialog_Organizer = buildTabContents(
      contents,
      false,
      false
    );
    _element_ConfigurationDialog_VisibleDays = buildTabContents(
      contents,
      false,
      false
    );

    _element_ConfigurationDialog_Display_EnableAutoRefresh = buildCheckBox(
      _element_ConfigurationDialog_Display,
      _options.enableAutoRefreshForEventsText
    )[0];
    _element_ConfigurationDialog_Display_EnableBrowserNotifications =
      buildCheckBox(
        _element_ConfigurationDialog_Display,
        _options.enableBrowserNotificationsText
      )[0];
    _element_ConfigurationDialog_Display_EnableTooltips = buildCheckBox(
      _element_ConfigurationDialog_Display,
    ...
    _element_ConfigurationDialog_Display_EnableDayNamesInMainDisplay =
      buildCheckBox(
        _element_ConfigurationDialog_Display,
    ...
    _element_ConfigurationDialog_Organizer_Name = createElement(
      'input',
      null,
      'text'
    );
    _element_ConfigurationDialog_Organizer.appendChild(
      _element_ConfigurationDialog_Organizer_Name
    );
    ...
    _element_ConfigurationDialog_Organizer_Email = createElement(
      'input',
      null,
      'text'
    );
    _element_ConfigurationDialog_Organizer.appendChild(
      _element_ConfigurationDialog_Organizer_Email
    );
    ...
    _element_ConfigurationDialog_VisibleDays_Mon = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[0]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Tue = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[1]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Wed = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[2]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Thu = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[3]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Fri = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[4]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Sat = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[5]
    )[0];
    _element_ConfigurationDialog_VisibleDays_Sun = buildCheckBox(
      _element_ConfigurationDialog_VisibleDays,
      _options.dayNames[6]
    )[0];
  }
  ...
  function configurationDialogEvent_OK() {
    var checkboxes =
        _element_ConfigurationDialog_Groups.getElementsByTagName('input'),
    ...
    _options.eventNotificationsEnabled =
      _element_ConfigurationDialog_Display_EnableBrowserNotifications.checked;
    _options.tooltipsEnabled =
      _element_ConfigurationDialog_Display_EnableTooltips.checked;
    _options.dragAndDropForEventsEnabled =
      _element_ConfigurationDialog_Display_EnableDragAndDropForEvents.checked;
    _options.showDayNamesInMainDisplay =
      _element_ConfigurationDialog_Display_EnableDayNamesInMainDisplay.checked;
    _options.organizerName = _element_ConfigurationDialog_Organizer_Name.value;
    _options.organizerEmailAddress =
      _element_ConfigurationDialog_Organizer_Email.value;
  ...
  function showConfigurationDialog() {
    ...
    _element_ConfigurationDialog_Display_EnableAutoRefresh.checked =
      _timer_RefreshMainDisplay !== null;
    _element_ConfigurationDialog_Display_EnableBrowserNotifications.checked =
      _options.eventNotificationsEnabled;
    _element_ConfigurationDialog_Display_EnableTooltips.checked =
    ...
    _element_ConfigurationDialog_Organizer_Email.value =
      _options.organizerEmailAddress;
    _element_ConfigurationDialog_VisibleDays_Mon.checked =
      _options.visibleDays.indexOf(0) > -1;
    _element_ConfigurationDialog_VisibleDays_Tue.checked =
      _options.visibleDays.indexOf(1) > -1;
    _element_ConfigurationDialog_VisibleDays_Wed.checked =
      _options.visibleDays.indexOf(2) > -1;
    _element_ConfigurationDialog_VisibleDays_Thu.checked =
      _options.visibleDays.indexOf(3) > -1;
    _element_ConfigurationDialog_VisibleDays_Fri.checked =
      _options.visibleDays.indexOf(4) > -1;
    _element_ConfigurationDialog_VisibleDays_Sat.checked =
      _options.visibleDays.indexOf(5) > -1;
    _element_ConfigurationDialog_VisibleDays_Sun.checked =
      _options.visibleDays.indexOf(6) > -1;
      ...
      _element_Tooltip_ShowTimer = setTimeout(function () {
        if (
          ...
          (!isDisabledBackgroundDisplayed() &&
            !isYearSelectorDropDownVisible() &&
            !isDropDownMenuVisible(_element_DropDownMenu_Day) &&
            !isDropDownMenuVisible(_element_DropDownMenu_Event))
        ) {
          text = isDefined(text) ? text : '';

          _element_Tooltip.className =
            text === '' ? 'calendar-tooltip-event' : 'calendar-tooltip';
          ...
          if (text !== '') {
            ...
            if (eventDetails.from.getDate() === eventDetails.to.getDate()) {
              if (eventDetails.isAllDay) {
                ...
                _element_Tooltip_Date.innerText = getTimeToTimeDisplay(
                  eventDetails.from,
                  eventDetails.to
                );
                _element_Tooltip_TotalTime.innerText =
  ...
  function checkEventForBrowserNotifications(date, event) {
    runBrowserNotificationAction(function () {
      if (
        isDateToday(date) &&
        !_eventNotificationsTriggered.hasOwnProperty(event.id)
      ) {
  ...
  function createElement(type, className, inputType) {
    ...
    if (!_elementTypes.hasOwnProperty(nodeType)) {
      _elementTypes[nodeType] = isText
        ? _document.createTextNode('')
        : _document.createElement(nodeType);
    }
        ...
        if (
          ...
          contents.push(
            '"' +
              propertyName +
              '":' +
              getPropertyValue(propertyName, orderedEvent[propertyName], true) +
              ','
          );
        }
      }
  ...
  function getICalContents(orderedEvents) {
    ...
    for (
      ...
      contents.push(
        'ORGANIZER;CN=' +
          getString(orderedEvent.organizerName) +
          ':MAILTO:' +
          getString(orderedEvent.organizerEmailAddress)
      );
  ...
  function moveToday() {
    ...
    if (
      _currentDate.getMonth() !== today.getMonth() ||
      _currentDate.getFullYear() !== today.getFullYear()
    ) {
      build();
